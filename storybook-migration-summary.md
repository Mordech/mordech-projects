...
- `yarn dlx storybook@latest automigrate --config-dir apps/web-components-storybook/.storybook --renderer @storybook/web-components`

- `yarn dlx storybook@latest automigrate --config-dir packages/react-components/.storybook --renderer @storybook/react`
