...
- `npx sb@next automigrate --config-dir apps/web-components-storybook/.storybook --renderer undefined`

- `npx sb@next automigrate --config-dir packages/react-components/.storybook --renderer undefined`
